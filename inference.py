...
parser.add_argument('--data_dir', type=str, default='/Users/wywy/Desktop/test1_img',
                    help='The directory containing the image data.')

parser.add_argument('--output_dir', type=str, default='./dataset/inference_output',
                    help='Path to the directory to generate the inference results')

parser.add_argument('--infer_data_list', type=str, default='/Users/wywy/Desktop/sample_images_list.txt',
...
#modle的输出predictions包含classes图片，probabilities概率图片，decoded_labels解码之后的图片
  for pred_dict, image_path in zip(predictions, image_files):
    ...
    mask = pred_dict['decoded_labels'] #取解码之后的图片作为结果
