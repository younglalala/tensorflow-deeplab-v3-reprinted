...
parser.add_argument('--image_data_dir', type=str, default='/Users/wywy/Desktop/VOCdevkit/VOC2012/JPEGImages',
                    help='The directory containing the image data.')

parser.add_argument('--label_data_dir', type=str, default='/Users/wywy/Desktop/VOCdevkit/VOC2012/SegmentationClassAug',
...
def main(unused_argv):
  ...
  features, labels = preprocessing.eval_input_fn(image_files, label_files)    #image=features

  predictions = deeplab_model.deeplabv3_model_fn(
      features,
      labels,
      tf.estimator.ModeKeys.EVAL,    #model
      params={
