...
def main(unused_argv):
  ...
  for _ in range(FLAGS.train_epochs // FLAGS.epochs_per_eval):   #26//1=26
    tensors_to_log = {
    ...
    logging_hook = tf.train.LoggingTensorHook(
        tensors=tensors_to_log, every_n_iter=10)    #每10次打印一次tensor_to_log 里面的信息。
    ...
    #input_fn：一个函数，提供由小 batches 组成的数据，tf.data.Dataset对象
    model.train(
